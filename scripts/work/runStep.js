...
const step0 = async (sleepTime,token) => {
    ...
    let config0 = "0" + tokenInfo.baseConfigFile;
...
const step1 = async (sleepTime,token) => {
    ...
    let {accounts,args,tokenInfo} = await getGlobalObj(token);
    let config0 = "0" + tokenInfo.baseConfigFile;
    let config1 = "1" + tokenInfo.baseConfigFile;
...
const step2 = async (sleepTime,token) => {
    ...
    let srcBridge = await readConfig("1" + tokenInfo.baseConfigFile,"SRC_BRIDGE");
    ...
    await writeConfig(
        "1" + tokenInfo.baseConfigFile,
        "2" + tokenInfo.baseConfigFile,
...
const step3 = async (sleepTime,token) => {
    ...
    let {accounts,args,tokenInfo} = await getGlobalObj(token);
    let config2 = "2" + tokenInfo.baseConfigFile;
...
const step4 = async (sleepTime,token) => {
    ...
    let config2 = "2" + tokenInfo.baseConfigFile;
    let config4 = "4" + tokenInfo.baseConfigFile;
    //DST_BRIDGE
