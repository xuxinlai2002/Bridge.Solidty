...
const main = async () => {
    ...
    console.log([safe.address,{gasPrice: args.gasPrice,gasLimit: args.gasLimit}]);
    console.log(upgrades.admin.transferProxyAdminOwnership);

    await upgrades.admin.transferProxyAdminOwnership(
            safe.address,{gasPrice: args.gasPrice,gasLimit: args.gasLimit});
